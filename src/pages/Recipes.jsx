...
export default function Recipes() {
  ...
  const { recipes, setRecipes, allRecipes, setAllRecipes } =
  ...
  const filterByCategory = async (category) => {
    ...
    const filterRecipeCategory = await fetchRecipeByCategory(
      pathname,
      category
    );
    const filter =
      selectedCategory === category ? allRecipes : filterRecipeCategory;
    setRecipes(filter);
  };
